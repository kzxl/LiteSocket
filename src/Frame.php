...
class Frame
{
    ...
    public static function encode(string $payload, int $opcode): string
    {
        ...
        if ($length <= 125) {
            ...
            // 64-bit length (pack 'J' in PHP 5.6.3+ unsigned 64-bit big-endian)
    ...
    /**
     * Decode a raw buffer from socket into a frame object, or null if incomplete.
     * Returns: ['opcode' => int, 'payload' => string, 'bytesConsumed' => int] or null.
     */
